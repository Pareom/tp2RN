...
def get_CIFAR10_data(num_training=49000, num_validation=1000, num_test=1000, dir=None):
    """
    ...
    cifar10_dir = 'ift725/datasets/cifar-10-batches-py' if dir is None else dir
